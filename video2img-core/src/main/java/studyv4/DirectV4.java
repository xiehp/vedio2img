 ...
 */
public class DirectV4 extends VlcjTest {

  private static DirectV4 app;
  ...
  public DirectV4(String media) throws InterruptedException, InvocationTargetException {
...
//      System.exit(1);
    ...
    args = new String[] {fileMrl.getAbsolutePath()};
    app = new DirectV4(args[0]);
